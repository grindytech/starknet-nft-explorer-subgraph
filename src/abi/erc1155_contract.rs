...
#[derive(Debug)]
pub struct erc1155<A: starknet::accounts::ConnectedAccount + Sync> {
    pub address: starknet::core::types::Felt,
    pub account: A,
    pub block_id: starknet::core::types::BlockId,
}
impl<A: starknet::accounts::ConnectedAccount + Sync> erc1155<A> {
...
#[derive(Debug)]
pub struct erc1155Reader<P: starknet::providers::Provider + Sync> {
    pub address: starknet::core::types::Felt,
    pub provider: P,
    pub block_id: starknet::core::types::BlockId,
}
impl<P: starknet::providers::Provider + Sync> erc1155Reader<P> {
...
pub struct TransferBatch {
    ...
    pub ids: Vec<cainome::cairo_serde::U256>,
    pub values: Vec<cainome::cairo_serde::U256>,
}
impl cainome::cairo_serde::CairoSerde for TransferBatch {
    type RustType = Self;
    const SERIALIZED_SIZE: std::option::Option<usize> = None;
    #[inline]
    fn cairo_serialized_size(__rust: &Self::RustType) -> usize {
        ...
        __size += Vec::<cainome::cairo_serde::U256>::cairo_serialized_size(&__rust.ids);
        __size
            += Vec::<cainome::cairo_serde::U256>::cairo_serialized_size(&__rust.values);
        __size
    }
    fn cairo_serialize(__rust: &Self::RustType) -> Vec<starknet::core::types::Felt> {
        let mut __out: Vec<starknet::core::types::Felt> = vec![];
        ...
        __out.extend(Vec::<cainome::cairo_serde::U256>::cairo_serialize(&__rust.ids));
        __out.extend(Vec::<cainome::cairo_serde::U256>::cairo_serialize(&__rust.values));
        __out
    }
    fn cairo_deserialize(
        __felts: &[starknet::core::types::Felt],
        ...
        __offset += Vec::<cainome::cairo_serde::U256>::cairo_serialized_size(&ids);
        let values = Vec::<
            cainome::cairo_serde::U256,
        >::cairo_deserialize(__felts, __offset)?;
        __offset += Vec::<cainome::cairo_serde::U256>::cairo_serialized_size(&values);
        Ok(TransferBatch {
            operator,
            from,
            to,
...
impl cainome::cairo_serde::CairoSerde for TransferSingle {
    type RustType = Self;
    const SERIALIZED_SIZE: std::option::Option<usize> = None;
    #[inline]
    fn cairo_serialized_size(__rust: &Self::RustType) -> usize {
...
#[derive(serde::Serialize, serde::Deserialize)]
pub struct URI {
    pub value: cainome::cairo_serde::ByteArray,
    pub id: cainome::cairo_serde::U256,
}
impl cainome::cairo_serde::CairoSerde for URI {
    type RustType = Self;
    const SERIALIZED_SIZE: std::option::Option<usize> = None;
    #[inline]
    fn cairo_serialized_size(__rust: &Self::RustType) -> usize {
        let mut __size = 0;
        __size += cainome::cairo_serde::ByteArray::cairo_serialized_size(&__rust.value);
        __size += cainome::cairo_serde::U256::cairo_serialized_size(&__rust.id);
        __size
    }
    fn cairo_serialize(__rust: &Self::RustType) -> Vec<starknet::core::types::Felt> {
        let mut __out: Vec<starknet::core::types::Felt> = vec![];
        __out.extend(cainome::cairo_serde::ByteArray::cairo_serialize(&__rust.value));
        __out.extend(cainome::cairo_serde::U256::cairo_serialize(&__rust.id));
        __out
    }
    fn cairo_deserialize(
        ...
        let mut __offset = __offset;
        let value = cainome::cairo_serde::ByteArray::cairo_deserialize(
            __felts,
            __offset,
        )?;
        __offset += cainome::cairo_serde::ByteArray::cairo_serialized_size(&value);
        let id = cainome::cairo_serde::U256::cairo_deserialize(__felts, __offset)?;
        __offset += cainome::cairo_serde::U256::cairo_serialized_size(&id);
        Ok(URI { value, id })
    }
...
#[derive(serde::Serialize, serde::Deserialize)]
pub enum ERC1155ComponentEvent {
    TransferSingle(TransferSingle),
    TransferBatch(TransferBatch),
    ApprovalForAll(ApprovalForAll),
    URI(URI),
}
impl cainome::cairo_serde::CairoSerde for ERC1155ComponentEvent {
    type RustType = Self;
    const SERIALIZED_SIZE: std::option::Option<usize> = std::option::Option::None;
    #[inline]
    fn cairo_serialized_size(__rust: &Self::RustType) -> usize {
        match __rust {
            ERC1155ComponentEvent::TransferSingle(val) => {
                TransferSingle::cairo_serialized_size(val) + 1
            }
            ERC1155ComponentEvent::TransferBatch(val) => {
                TransferBatch::cairo_serialized_size(val) + 1
            }
            ERC1155ComponentEvent::ApprovalForAll(val) => {
                ApprovalForAll::cairo_serialized_size(val) + 1
            }
            ERC1155ComponentEvent::URI(val) => URI::cairo_serialized_size(val) + 1,
            _ => 0,
        }
    }
    fn cairo_serialize(__rust: &Self::RustType) -> Vec<starknet::core::types::Felt> {
        match __rust {
            ERC1155ComponentEvent::TransferSingle(val) => {
                let mut temp = vec![];
                temp.extend(usize::cairo_serialize(&0usize));
                temp.extend(TransferSingle::cairo_serialize(val));
                temp
            }
            ERC1155ComponentEvent::TransferBatch(val) => {
                let mut temp = vec![];
                temp.extend(usize::cairo_serialize(&1usize));
                temp.extend(TransferBatch::cairo_serialize(val));
                temp
            }
            ERC1155ComponentEvent::ApprovalForAll(val) => {
                let mut temp = vec![];
            ...
            ERC1155ComponentEvent::URI(val) => {
                let mut temp = vec![];
                temp.extend(usize::cairo_serialize(&3usize));
                temp.extend(URI::cairo_serialize(val));
                temp
            }
            _ => vec![],
        }
    ...
    fn cairo_deserialize(
        ...
        match __index as usize {
            0usize => {
                Ok(
                    ERC1155ComponentEvent::TransferSingle(
                        TransferSingle::cairo_deserialize(__felts, __offset + 1)?,
                    ),
                )
            }
            1usize => {
                Ok(
                    ERC1155ComponentEvent::TransferBatch(
                        TransferBatch::cairo_deserialize(__felts, __offset + 1)?,
                    ),
                )
            }
            2usize => {
                Ok(
                    ERC1155ComponentEvent::ApprovalForAll(
            ...
            3usize => {
                Ok(
                    ERC1155ComponentEvent::URI(
                        URI::cairo_deserialize(__felts, __offset + 1)?,
                    ),
                )
            }
            _ => {
                return Err(
                    cainome::cairo_serde::Error::Deserialize(
                        format!("Index not handle for enum {}", "ERC1155ComponentEvent"),
                    ),
                );
            }
        }
...
impl TryFrom<starknet::core::types::EmittedEvent> for ERC1155ComponentEvent {
    type Error = String;
    fn try_from(
        event: starknet::core::types::EmittedEvent,
    ) -> Result<Self, Self::Error> {
        ...
        let selector = event.keys[0];
        if selector
            == starknet::core::utils::get_selector_from_name("TransferSingle")
                .unwrap_or_else(|_| panic!("Invalid selector for {}", "TransferSingle"))
        {
            let mut key_offset = 0 + 1;
            let mut data_offset = 0;
            ...
            return Ok(
                ERC1155ComponentEvent::TransferSingle(TransferSingle {
                    operator,
                    from,
                    to,
                    id,
        ...
        let selector = event.keys[0];
        if selector
            == starknet::core::utils::get_selector_from_name("TransferBatch")
                .unwrap_or_else(|_| panic!("Invalid selector for {}", "TransferBatch"))
        {
            let mut key_offset = 0 + 1;
            let mut data_offset = 0;
            let operator = match cainome::cairo_serde::ContractAddress::cairo_deserialize(
            ...
            >::cairo_deserialize(&event.data, data_offset) {
                ...
                Err(e) => {
                    return Err(
                        format!(
                            "Could not deserialize field {} for {}: {:?}", "ids",
                            "TransferBatch", e
                        ),
                    );
                }
            ...
            data_offset
                += Vec::<cainome::cairo_serde::U256>::cairo_serialized_size(&ids);
            ...
            data_offset
                += Vec::<cainome::cairo_serde::U256>::cairo_serialized_size(&values);
            return Ok(
                ERC1155ComponentEvent::TransferBatch(TransferBatch {
                    operator,
                    from,
                    to,
                    ids,
                ...
                .unwrap_or_else(|_| panic!("Invalid selector for {}", "ApprovalForAll"))
        {
            ...
            return Ok(
                ERC1155ComponentEvent::ApprovalForAll(ApprovalForAll {
                    owner,
                    operator,
                    approved,
                }),
        ...
        let selector = event.keys[0];
        if selector
            == starknet::core::utils::get_selector_from_name("URI")
                .unwrap_or_else(|_| panic!("Invalid selector for {}", "URI"))
        {
            let mut key_offset = 0 + 1;
            let mut data_offset = 0;
            let value = match cainome::cairo_serde::ByteArray::cairo_deserialize(
                &event.data,
                data_offset,
            ) {
                Ok(v) => v,
            ...
            data_offset
                += cainome::cairo_serde::ByteArray::cairo_serialized_size(&value);
            let id = match cainome::cairo_serde::U256::cairo_deserialize(
                &event.keys,
                key_offset,
            ) {
                ...
                Err(e) => {
                    return Err(
                        format!(
                            "Could not deserialize field {} for {}: {:?}", "id", "URI", e
                        ),
                    );
                }
            };
            key_offset += cainome::cairo_serde::U256::cairo_serialized_size(&id);
            return Ok(ERC1155ComponentEvent::URI(URI { value, id }));
        }
        Err(format!("Could not match any event from keys {:?}", event.keys))
    }
}
...
pub enum Event {
    ...
    ERC1155Event(ERC1155ComponentEvent),
...
impl cainome::cairo_serde::CairoSerde for Event {
    ...
    fn cairo_serialized_size(__rust: &Self::RustType) -> usize {
        match __rust {
            ...
            Event::ERC1155Event(val) => {
                ERC1155ComponentEvent::cairo_serialized_size(val) + 1
            }
    ...
    fn cairo_serialize(__rust: &Self::RustType) -> Vec<starknet::core::types::Felt> {
        match __rust {
            ...
            Event::ERC1155Event(val) => {
                let mut temp = vec![];
                temp.extend(usize::cairo_serialize(&1usize));
                temp.extend(ERC1155ComponentEvent::cairo_serialize(val));
                temp
            }
            Event::SRC5Event(val) => {
                let mut temp = vec![];
    ...
    fn cairo_deserialize(
        ...
        match __index as usize {
            ...
            1usize => {
                Ok(
                    Event::ERC1155Event(
                        ERC1155ComponentEvent::cairo_deserialize(__felts, __offset + 1)?,
                    ),
                )
            }
            2usize => {
...
impl TryFrom<starknet::core::types::EmittedEvent> for Event {
    ...
    fn try_from(
                ...
                .unwrap_or_else(|_| panic!("Invalid selector for {}", "URI"))
        {
            ...
            key_offset += cainome::cairo_serde::U256::cairo_serialized_size(&id);
            return Ok(
                Event::ERC1155Event(ERC1155ComponentEvent::URI(URI { value, id })),
            );
        }
        Err(format!("Could not match any event from keys {:?}", event.keys))
    }
...
impl<A: starknet::accounts::ConnectedAccount + Sync> erc1155<A> {
    ...
    pub fn balanceOfBatch(
        &self,
        accounts: &Vec<cainome::cairo_serde::ContractAddress>,
    ...
    > {
        ...
        __calldata
            .extend(
                Vec::<cainome::cairo_serde::ContractAddress>::cairo_serialize(accounts),
            );
        __calldata.extend(Vec::<cainome::cairo_serde::U256>::cairo_serialize(tokenIds));
        let __call = starknet::core::types::FunctionCall {
            contract_address: self.address,
            entry_point_selector: starknet::macros::selector!("balanceOfBatch"),
            calldata: __calldata,
        };
        cainome::cairo_serde::call::FCall::new(__call, self.provider())
    }
    ...
    pub fn balance_of_batch(
        &self,
        accounts: &Vec<cainome::cairo_serde::ContractAddress>,
        token_ids: &Vec<cainome::cairo_serde::U256>,
    ) -> cainome::cairo_serde::call::FCall<
        A::Provider,
        Vec<cainome::cairo_serde::U256>,
    > {
        ...
        __calldata.extend(Vec::<cainome::cairo_serde::U256>::cairo_serialize(token_ids));
        let __call = starknet::core::types::FunctionCall {
            contract_address: self.address,
            entry_point_selector: starknet::macros::selector!("balance_of_batch"),
            calldata: __calldata,
        };
        cainome::cairo_serde::call::FCall::new(__call, self.provider())
    }
    ...
    > {
        ...
        let __call = starknet::core::types::FunctionCall {
            contract_address: self.address,
            entry_point_selector: starknet::macros::selector!("uri"),
            calldata: __calldata,
        };
        cainome::cairo_serde::call::FCall::new(__call, self.provider())
    }
    ...
    pub fn mint_getcall(
        ...
        tokenId: &cainome::cairo_serde::U256,
        value: &cainome::cairo_serde::U256,
        ...
        __calldata.extend(cainome::cairo_serde::U256::cairo_serialize(tokenId));
        __calldata.extend(cainome::cairo_serde::U256::cairo_serialize(value));
    ...
    pub fn mintBatch_getcall(
        ...
        to: &cainome::cairo_serde::ContractAddress,
        tokenIds: &Vec<cainome::cairo_serde::U256>,
        values: &Vec<cainome::cairo_serde::U256>,
        data: &Vec<starknet::core::types::Felt>,
    ) -> starknet::core::types::Call {
        use cainome::cairo_serde::CairoSerde;
        let mut __calldata = vec![];
        __calldata.extend(cainome::cairo_serde::ContractAddress::cairo_serialize(to));
        __calldata.extend(Vec::<cainome::cairo_serde::U256>::cairo_serialize(tokenIds));
        __calldata.extend(Vec::<cainome::cairo_serde::U256>::cairo_serialize(values));
        __calldata.extend(Vec::<starknet::core::types::Felt>::cairo_serialize(data));
        starknet::core::types::Call {
            to: self.address,
    ...
    #[allow(clippy::ptr_arg)]
    #[allow(clippy::too_many_arguments)]
    pub fn safeBatchTransferFrom_getcall(
        &self,
        ...
        starknet::core::types::Call {
            to: self.address,
            selector: starknet::macros::selector!("safeBatchTransferFrom"),
            calldata: __calldata,
        }
    }
    #[allow(clippy::ptr_arg)]
    ...
    #[allow(clippy::ptr_arg)]
    #[allow(clippy::too_many_arguments)]
    pub fn safe_batch_transfer_from_getcall(
        &self,
        from: &cainome::cairo_serde::ContractAddress,
        to: &cainome::cairo_serde::ContractAddress,
        token_ids: &Vec<cainome::cairo_serde::U256>,
        ...
        starknet::core::types::Call {
            to: self.address,
            selector: starknet::macros::selector!("safe_batch_transfer_from"),
            calldata: __calldata,
        }
    }
    #[allow(clippy::ptr_arg)]
    ...
    pub fn setURI_getcall(
        ...
        starknet::core::types::Call {
            to: self.address,
            selector: starknet::macros::selector!("setURI"),
            calldata: __calldata,
        }
    }
    #[allow(clippy::ptr_arg)]
